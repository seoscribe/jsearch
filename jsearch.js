;(function(win, doc) {
  ...
  function init(config) {
    ...
    doc.querySelector(_append_to).insertAdjacentHTML('beforeend', '<button id="searchbutton" tabindex="1"></button><form method="GET" action="/" id="search"><input type="text" title="Search for a particular example" required></form><div id="results" aria-hidden="true" hidden><button id="close" tabindex="1"></button><div><h2></h2></div></div>');
